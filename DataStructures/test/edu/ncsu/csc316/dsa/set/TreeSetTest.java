...
public class TreeSetTest {
	...
	/** set of integer used for testing */
    ...
    public void testRemove() {
        ...
        assertEquals("5", set.remove(5).toString());
        assertEquals(4, set.size());
        assertEquals("10", set.remove(10).toString());
    ...
    public void testIterator() {
        ...
        assertEquals("10", it.next().toString());
        assertEquals("15", it.next().toString());
        assertEquals("20", it.next().toString());
        assertEquals("25", it.next().toString());
    }
}