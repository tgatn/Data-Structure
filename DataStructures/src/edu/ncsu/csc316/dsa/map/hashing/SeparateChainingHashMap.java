 ...
 * supports worst-case O(logn) runtime for put, get, and remove within each bucket.
 * 
...
public class SeparateChainingHashMap<K extends Comparable<K>, V> extends AbstractHashMap<K, V> {
	 ...
	 * bucketPut algorithm on page 425 in the course textbook "Data Structures and
	...
	/**
	 * Citing Help from the Textbooks The code for this method is based on the
	 * bucketRemove algorithm on page 425 in the course textbook "Data Structures and
	 * Algorithms" by Goodrich, Tamassia, Goldwasser.
	 */
	@Override
