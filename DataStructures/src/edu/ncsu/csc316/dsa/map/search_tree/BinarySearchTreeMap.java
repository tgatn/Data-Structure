...
public class BinarySearchTreeMap<K extends Comparable<K>, V> extends AbstractOrderedMap<K, V> {
	...
	/** instance of BalanceableBinaryTree */
	 ...
	 * @param compare is comparator to be used on the BST map
	 */
	...
	protected static class BalanceableBinaryTree<K, V> extends LinkedBinaryTree<Entry<K, V>> {
		...
		protected static class BSTNode<E> extends BinaryTreeNode<E> {
			...
			/** stores an additional piece of information depending ont the type of tree */
	 ...
	 * @return returns the position of the root
	 */
	 ...
	 * @param p position that the parent will get obtained from
	...
	/**
	 * Determines if the position is an internal node
	 * @param p is position to be determined if it is an internal node
	...
	/**
	 * Replaces the entry of a certain position with the entry from the parameter
	 * @param p is position to be modifed
	 * @param entry is information that will replace current entry in position p
	 * @return original entry in position p
	 * @throws IllegalArgumentException if the position, p, does not represent a
     *                                  valid tree position
	 */
	...
	/**
	 * Determines if a certain position if a leaf
	 * @param p is position to be evaluated
	 * @return true if position p is a leaf; false otherwise
	 * @throws IllegalArgumentException if the position, p, does not represent a
     *                                  valid tree position
	 */
	...
	/**
	 * Determines if a certain position if a root
	 * @param p is position to be evaluated
	 * @return true if position p is a root; false otherwise
	 * @throws IllegalArgumentException if the position, p, does not represent a
     *                                  valid tree position
	 */
	 ...
	 * @param p is position for which the child will be returned from
	 ...
	 * @param p is position for which the sibling will be returned from
