...
public class AdjacencyListGraph<V, E> extends AbstractGraph<V, E> {
    ...
    public Edge<E> insertEdge(Vertex<V> v1, Vertex<V> v2, E edgeData) {
        ...
        Position<Edge<E>> out = origin.getOutgoing().addLast(edge);
        Position<Edge<E>> in = destination.getIncoming().addLast(edge);
        edge.setOutgoingListPosition(out);
        edge.setIncomingListPosition(in);
        return edge;
    }
    ...
    public void removeEdge(Edge<E> edge) {
        ...
        Position<Edge<E>> out = e.getOutgoingListPosition();
        Position<Edge<E>> in = e.getIncomingListPosition();
        
        origin.getOutgoing().remove(out);
        dest.getIncoming().remove(in);
     ...
     * 
     * @param e is edge to be validated
