...
public class AdjacencyMatrixGraph<V, E> extends AbstractGraph<V, E> {
    ...
    public void removeEdge(Edge<E> edge) {
        ...
        MatrixVertex start = validate(endVertices(e)[0]);
        MatrixVertex end = validate(endVertices(e)[1]);
        
        edgeList.remove(e.getPosition());
        
        matrix[start.getIndex()][end.getIndex()] = null;
        matrix[end.getIndex()][start.getIndex()] = null;
    }
