...
public class LinkedBinaryTree<E> extends AbstractBinaryTree<E> {
	...
	/** binary tree node of a generic type e */
    private BinaryTreeNode<E> root;
    
    /** size of linked binary tree */
    private int size;
    ...
    public static class BinaryTreeNode<E> extends AbstractTreeNode<E> {
    	...
    	/** parent node of a binary tree */
        private BinaryTreeNode<E> parent;
        
        /** left node of a binary tree */
    ...
    /**
	 * The code for this method is based on the addLeft algorithm on page 328 in the
    ...
    /**
	 * The code for this method is based on the addRight algorithm on page 328 in the
	 * course textbook "Data Structures and Algorithms" by Goodrich, Tamassia,
	 * Goldwasser.
	 */
    @Override
    ...
    /**
	 * The code for this method is based on the remove algorithm on page 329 in the
	 * course textbook "Data Structures and Algorithms" by Goodrich, Tamassia,
	 * Goldwasser.
	 */
    @Override
