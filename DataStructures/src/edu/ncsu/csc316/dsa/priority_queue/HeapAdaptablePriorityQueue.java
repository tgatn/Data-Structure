 ...
 * AdaptablePriorityQueue abstract data type. HeapAdaptablePriorityQueue ensures
 * a O(logn) worst-case runtime for insert, deleteMin, remove, and replaceKey.
 * HeapAdaptablePriorityQueue ensures a O(1) worst-case runtime for min, size,
 * isEmpty, and replaceValue.
 * 
...
public class HeapAdaptablePriorityQueue<K extends Comparable<K>, V> extends HeapPriorityQueue<K, V>
	...
	public void remove(Entry<K, V> entry) {
		 ...
		 * remove algorithm on page 394 in the course textbook "Data Structures and
	...
	public void replaceKey(Entry<K, V> entry, K key) {
		/*
		 * Citing Help from the Textbooks The code for this method is based on the
		 * replaceKey algorithm on page 394 in the course textbook "Data Structures and
		 * Algorithms" by Goodrich, Tamassia, Goldwasser.
		 */
		AdaptablePQEntry<K, V> locator = validate(entry);
		locator.setKey(key);
	...
	public void replaceValue(Entry<K, V> entry, V value) {
		/*
		 * Citing Help from the Textbooks The code for this method is based on the
		 * replaceValue algorithm on page 394 in the course textbook "Data Structures and
		 * Algorithms" by Goodrich, Tamassia, Goldwasser.
		 */
		AdaptablePQEntry<K, V> locator = validate(entry);
